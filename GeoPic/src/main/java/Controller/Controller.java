...
public class Controller {
    ...
    /**
     * Recupera la galleria privata dell'utente attualmente loggato.
     * @return La {@link GalleriaPrivata} trovata tra le gallerie possedute dall'utente,
     * oppure null se l'utente non ne possiede una.
     */
    ...
    /**
     * Verifica se un determinato utente fa parte dei partecipanti di una galleria condivisa.
     * @param gallCond La {@link GalleriaCondivisa} da controllare.
     * @param utente L'{@link Utente} di cui verificare la partecipazione.
     * @return {@code true} se l'utente partecipa alla galleria, {@code false} altrimenti.
     */
